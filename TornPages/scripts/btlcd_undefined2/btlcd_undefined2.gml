...
/*/////////////////////////////////////////////////
	...
	//BGM
	script_execute(scr_change_song,bgm_path_of_destruction,btl_music_fadeout_spd)
	
	victory_music=bgm_fanfare_theme

	
	//BKG
	var background = layer_background_get_id(layer_get_id("battle_background_layer"));
	layer_background_sprite(background, bkg_btl_basic)
